      ...
      <Card variant="glass" padding="lg" className={cn('space-y-4', className)}>
        <div className="space-y-1">
          ...
          <h2 className="font-display text-xl font-semibold tracking-tight sm:text-2xl">
            {t('toursOps.multiDay.dayOf', { current: currentDay, total: totalDays })}
          </h2>
        </div>
        ...
        <div
          ...
          aria-valuemin={0}
          aria-valuemax={100}
          aria-label={t('toursOps.multiDay.percentComplete', { percent })}
        >
          <div
        ...
        <p className="text-sm font-medium text-foreground">
          {t('toursOps.multiDay.percentComplete', { percent })}
        </p>
      </Card>
    </motion.div>
  );
